...
public class Logger {
    ...
    public void debug(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.BLUE_BRIGHT + "[DEBUG]: " + ConsoleColors.BLUE + message);
    }
    public void log(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.YELLOW_BRIGHT + "[INFO]: " + ConsoleColors.YELLOW + message);
    }
    public void progress(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.PURPLE_BRIGHT + "[PROGRESS]: " + ConsoleColors.PURPLE + message);
    }
    public void success(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.GREEN_BRIGHT + "[SUCCESS]: " + ConsoleColors.GREEN + message);
    }
    public void error(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.RED_BRIGHT + "[ERROR]: " + ConsoleColors.RED + message);
    }
    public void fatal(String message){
        System.out.println(ConsoleColors.BLACK_BRIGHT + "["+currentTime()+"] " + ConsoleColors.BLACK + ConsoleColors.RED_BACKGROUND + "[FATAL]" + ConsoleColors.RESET + ConsoleColors.RED_BRIGHT + ": " + ConsoleColors.RED + message);
    }
    ...
    //main.java.fakeadmin.log alternatives
